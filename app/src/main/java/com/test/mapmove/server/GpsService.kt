package com.test.mapmove.server
...
import com.test.mapmove.manager.FloatingViewManger
...
import com.test.mapmove.utils.CalculationLogLatDistance
import com.test.mapmove.utils.LocationUtils
import com.test.mapmove.utils.MMKVUtils
import com.test.mapmove.utils.RouteBindingUtils
...
class GpsService : Service() {
    ...
    private fun mapMove(location: Location) {
        locationManager?.run {
            try {
