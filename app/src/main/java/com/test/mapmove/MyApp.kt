...
class MyApp : BaseApp() {
    ...
    private fun initReceiver() {
        ...
        intentFilter.addAction("com.test.mapmove.navi")
        registerReceiver(mMockReceiver, intentFilter)
//        mMockReceiver is missing RECEIVER_EXPORTED or RECEIVER_NOT_EXPORTED flag for unprotected broadcasts registered for com.test.mapmove.navi
    }
}